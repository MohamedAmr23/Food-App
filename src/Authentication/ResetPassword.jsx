  ...
  return (
    <div>
      ...
      <form className="mt-3" onSubmit={handleSubmit(onSubmit)}>
        ...
        {errors.seed && <p className="text-danger mb-2" style={{ fontSize: '13px' }}>{errors.seed.message}</p>}
        ...
        {errors.confirmPassword && <p className="text-danger mb-2" style={{ fontSize: '13px' }}>{errors.confirmPassword.message}</p>}
