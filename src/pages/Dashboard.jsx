...
const Dashboard = () => {
  ...
  const quickActions = [
    { icon: 'fa-plus-circle', label: 'Add New Recipe',      desc: 'Create a new menu item',       color: 'success', path: '/dashboard/recipes'    },
    { icon: 'fa-list',        label: 'Manage Categories',   desc: 'Organize your menu sections',  color: 'primary', path: '/dashboard/categories' },
    { icon: 'fa-users',       label: 'View Users',          desc: 'See all registered users',     color: 'warning', path: '/dashboard/users'      },
    { icon: 'fa-key',         label: 'Change Password',     desc: 'Update your credentials',      color: 'danger',  path: '/dashboard/change-password' },
  ]
    ...
    <>
      ...
      <div className="container-fluid px-4 py-4">
        ...
        <div className="row g-3 mb-4">
          {[
            { label: 'Total Recipes',     value: stats.recipes,    icon: 'fa-utensils', color: 'success', sub: 'Menu items available',  path: '/dashboard/recipes'    },
            { label: 'Categories',        value: stats.categories, icon: 'fa-list',     color: 'primary', sub: 'Active categories',     path: '/dashboard/categories' },
            { label: 'Registered Users',  value: stats.users,      icon: 'fa-users',    color: 'warning', sub: 'Platform members',      path: '/dashboard/users'      },
            ...
            <div className="card border-0 shadow-sm h-100">
              <div className="card-header bg-white border-bottom py-3">
                <h5 className="fw-bold mb-0">
                  <i className="fa fa-bolt text-warning me-2"></i> Quick Actions
                </h5>
                ...
                <div className="d-flex flex-column gap-2">
                  {quickActions.map(({ icon, label, desc, color, path }) => (
                    <button
                      ...
                      onMouseEnter={e => e.currentTarget.style.borderColor = `var(--bs-${color})`}
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-muted mb-0" style={{ fontSize: '0.78rem' }}>{desc}</p>
                      </div>
          ...
          <div className="col-lg-7">
            <div className="card border-0 shadow-sm h-100">
              <div className="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center">
                <div>
                  <h5 className="fw-bold mb-0">
                    <i className="fa fa-clock text-success me-2"></i> Recent Recipes
                  </h5>
                  <p className="text-muted small mb-0">Latest items on the menu</p>
                </div>
                <button
                    ...
                    {recentRecipes.map((recipe) => (
                      ...
                      >
                        ...
                        <div className="flex-grow-1" style={{ minWidth: 0 }}>
                          <p className="fw-semibold mb-0 text-truncate">{recipe.name}</p>
